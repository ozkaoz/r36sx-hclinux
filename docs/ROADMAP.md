...
| **9-6c** | **Kernel module loader** | OOPS en resolve_symbol (module.c:1411) con cualquier .ko — loaders mueren SIGSEGV + mutex lockeado. Workaround: built-ins. Fix real pendiente (bloquea wifi-modules) | ⏳ PENDIENTE |
