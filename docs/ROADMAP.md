...
| **9-6d** | Internet por USB | **F1 PHYSICAL PASS (2026-09-25)**: internet vía PC con ICS (fork 284478a: default gw + DNS; ping 8.8.8.8/DNS/wget OK). La consola NO tiene antena Wi-Fi ni dongle. F2 vía celular: drivers host `USB_USBNET`/`CDCETHER`/`RNDIS_HOST` como .ko (loader 9-6c OK) | 🔶 F1 DONE / F2 pendiente |
