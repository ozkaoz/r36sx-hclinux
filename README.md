...
- Factory bootloader preserved (NOR contract documented, 2 attempts to replace resulted in brickeos)
...
- [Recovery Kit](D:/R36SX/hcprogrammer-restore-kit/) — restore factory NOR
